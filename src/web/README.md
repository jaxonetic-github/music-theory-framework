...
The v8.8 repository suite contains **379 passing tests**: 325 plain-Node tests and 54 React DOM tests. `npm audit` reports **0 vulnerabilities**. Vite transforms **331 modules** and emits 526.99 kB JavaScript (141.72 kB gzip). The Next.js 15.5.22 fixture compiles and statically prerenders successfully with an 84 kB app route and 186 kB first-load JavaScript.
