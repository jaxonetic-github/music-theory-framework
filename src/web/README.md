...
The v8.8 repository suite contains **390 passing tests**: 336 plain-Node tests and 54 React DOM tests. `npm audit` reports **0 vulnerabilities**. Vite transforms **332 modules** and emits 529.64 kB JavaScript (142.57 kB gzip). The Next.js 15.5.22 fixture compiles and statically prerenders successfully with an 84.8 kB app route and 187 kB first-load JavaScript.
