...
The v8.8 repository suite contains **375 passing tests**: 321 plain-Node tests and 54 React DOM tests. `npm audit` reports **0 vulnerabilities**. Vite transforms **331 modules** and emits 523.71 kB JavaScript (140.61 kB gzip). The Next.js 15.5.22 fixture compiles and statically prerenders successfully with an 83.1 kB app route and 185 kB first-load JavaScript.
