...
export const registriesPackageDescriptor = new PackageDescriptor({
    ...
    description: "Typed runtime registries for packages, modules, services, plugins, themes, generators, renderers, exporters, playback planners, exercises, and workspaces.",
    version: "6.1.0",
    ...
    capabilities: ["typed-registration", "alias-resolution", "registry-snapshots", "registry-events", "exercise-discovery"],
