...
Playback Planning Core is covered by 23 focused acceptance tests. The complete repository suite contains **222 passing tests**. Production Web build and `git diff --check` are also validated.
