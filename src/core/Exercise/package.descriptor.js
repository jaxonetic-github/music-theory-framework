...
export const exercisePackageDescriptor = new PackageDescriptor({
    ...
    version: "8.0.0", layer: "application", category: "application", role: "provider", stability: "stable", visibility: "public",
    dependencies: [
    ...
    capabilities: ["exercise-generation", "semantic-music-material", "all-keys", "plugin-scoped-strategies"],
    ...
    provides: [
        ...
        { id: "exercise.foundational", kind: "exercise" }, { id: "exercise.model", kind: "value" }
    ],
