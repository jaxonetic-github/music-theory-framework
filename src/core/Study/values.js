...
export class StudyRequest {
    constructor({studyId="full-daily-technical-study",keyScope="selected-key",keyTraversal="canonical",root="C",octaves=2,startingOctave=4,direction="ascending-descending",measuresPerSystem=4,duration={numerator:1,denominator:8},clef="treble",timeSignature={beats:4,beatUnit:4},keySignaturePolicy="exercise-root",progression="ii-v-i-major",realization="blocked",harmonicRhythm="one-per-measure",annotationPolicy="both"}={}){
