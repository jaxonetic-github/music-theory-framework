...
export class ExercisePresentationRow {
    constructor({ id, modelId, sectionId, sourceRow, notationRow, graph, systems, layoutPlan = null, content, format, mediaType, rendererPluginId, rendererStrategyId, sequence, metadata = {} } = {}) {
        ...
        if (!(layoutPlan instanceof LayoutPlan) || layoutPlan.score !== graph) throw new ValidationError("Exercise presentation row requires its authoritative LayoutPlan.");
        Object.defineProperties(this, { id: { value: values[0], enumerable: true }, modelId: { value: values[1], enumerable: true }, sectionId: { value: values[2], enumerable: true }, exerciseRowId: { value: sourceRow.id, enumerable: true }, notationRowId: { value: notationRow.id, enumerable: true }, sourceRow: { value: sourceRow, enumerable: true }, notationRow: { value: notationRow, enumerable: true }, graph: { value: graph, enumerable: true }, layoutPlan: { value: layoutPlan, enumerable: true }, systems: { value: Object.freeze([...systems]), enumerable: true }, title: { value: sourceRow.title, enumerable: true }, root: { value: sourceRow.root, enumerable: true }, type: { value: sourceRow.type, enumerable: true }, pattern: { value: sourceRow.pattern, enumerable: true }, quality: { value: sourceRow.quality, enumerable: true }, content: { value: content, enumerable: true }, format: { value: values[3], enumerable: true }, mediaType: { value: values[4], enumerable: true }, rendererPluginId: { value: values[5], enumerable: true }, rendererStrategyId: { value: values[6], enumerable: true }, sequence: { value: sequence, enumerable: true }, metadata: { value: freezeDeep(cloneDeep(metadata)), enumerable: true } }); Object.freeze(this);
    }
}
