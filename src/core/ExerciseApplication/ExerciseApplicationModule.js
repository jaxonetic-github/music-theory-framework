...
export class ExerciseApplicationModule {
    ...
    constructor({ engine = null, exerciseEngine = null, notationEngine = null, renderingEngine = null } = {}) {
        ...
        this.engine = engine; this.plugin = engine ? this.#pluginFor(engine) : null; Object.seal(this);
    }
    configure({ services, registries }) {
        ...
        const plugin = this.#injectedEngine ? this.plugin : this.#pluginFor(engine); const undo = [];
    ...
    #pluginFor(engine) { return Object.freeze({ id: String(exerciseApplicationPluginDescriptor.id), workflows: Object.freeze([engine]) }); }
}
