...
The `TheoryModule` publishes catalog services through the service registry and generation services through both the service container and generator registry.
